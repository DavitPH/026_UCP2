...
fun Konfirmasi(
    ...
    val items = listOf(
        ...
        Pair (stringResource(R.string.nim), TugasUIState.nim),
        Pair (stringResource(id = R.string.konsen),TugasUIState.konsen),
        Pair (stringResource(R.string.judul), TugasUIState.judul),
        Pair (stringResource(R.string.dosen), TugasUIState.dosen)
